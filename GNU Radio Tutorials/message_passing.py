...
import message_passing_epy_block_0 as epy_block_0  # embedded python block
import message_passing_epy_block_1 as epy_block_1  # embedded python block
import sip



class message_passing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "message_passing")
        ...
        self.epy_block_1 = epy_block_1.blk(num_samples_to_count=32e3)
...
def main(top_block_cls=message_passing, options=None):
