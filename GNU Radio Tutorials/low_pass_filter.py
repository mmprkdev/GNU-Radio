...
class low_pass_filter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_ccc(interpolation_rate, lowPassTaps)
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
