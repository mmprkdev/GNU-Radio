...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            ...
            "Maintaining Original Frequency", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, (samp_rate*3), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate*3)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_gr_complex*1, 3)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_repeat_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.samp_rate*3))
