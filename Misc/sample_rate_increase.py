...
class sample_rate_increase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sample_rate_increase")
...
def main(top_block_cls=sample_rate_increase, options=None):
