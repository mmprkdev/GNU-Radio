...
class fan_remote(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fan_remote")
        ...
        self.freq = freq = 304e6

        ##################################################
        # Blocks
        ##################################################

        self._freq_range = Range(304e6 - 20e6, 304e6 + 20e6, .2e6, 304e6, 200)
...
def main(top_block_cls=fan_remote, options=None):
