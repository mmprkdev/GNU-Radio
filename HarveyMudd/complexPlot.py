...
class complexPlot(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "complexPlot", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("complexPlot")
        ...
        self.settings = Qt.QSettings("GNU Radio", "complexPlot")
        ...
        self._freq_range = Range(-100e3, 100e3, 1, 1000, 200)
        ...
        self.connect((self.blocks_conjugate_cc_0, 0), (self.blocks_add_xx_0, 1))
...
def main(top_block_cls=complexPlot, options=None):
